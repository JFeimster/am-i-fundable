...
export function buildScoreSubmission(result = {}, lead = {}, source = "Funding Readiness Scorecard") {
  ...
  return {
    ...
    scoreResult: toPublicScoreResult(result)
  };
}
...
function toPublicScoreResult(result = {}) {
  return {
    valid: result.valid,
    score: result.score,
    tier: result.tier,
    leadPriority: result.leadPriority,
    primaryFundingFamily: result.primaryFundingFamily,
    secondaryFundingFamilies: result.secondaryFundingFamilies || [],
    ...
    cta: result.cta,
    calculatedAt: result.calculatedAt || result.createdAt
  };
}
