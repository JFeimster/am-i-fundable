  ...
  const demoQueue = [
    {
      ...
      reasonCodes: ["mixed_readiness_signals", "document_review_needed"],
    ...
    },
    {
      ...
      priority: "hot",
      tierId: "highly_fundable",
      reasonCodes: ["strong_revenue_signal", "documents_needed"],
      createdAt: new Date(Date.now() - 1000 * 60 * 90).toISOString()
    }
  ];

  return sendJson(res, 200, {
    status: "demo_queue_returned",
    visibility: "internal_admin_only",
    queueName: "funding_strategy_review",
    count: demoQueue.length,
    items: demoQueue,
    note: "Demo queue only. Connect a private CRM/database before using this route operationally."
  });
}
